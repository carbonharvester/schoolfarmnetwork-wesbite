...
test('Prerendered content and metadata survive without JavaScript',()=>{
 ...
 for(const text of ['School Farm Network | A future without school hunger','School is a','Rooted in real work.','Better nutrition','Local opportunity','Learning that lasts','School%20Farm%20Network%20enquiry','noindex,nofollow,noarchive']) assert.ok(html.includes(text),text);
