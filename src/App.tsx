...
export default function App(){
 ...
 return <div ref={scope} id="top" className="direction-photo"><a className="skip-link" href="#main">Skip to content</a>
  ...
  <main id="main" tabIndex={-1}>
   ...
   <section className="first-farm" id="first-farm" aria-labelledby="first-farm-heading"><h2 id="first-farm-heading">Our <em>first farm.</em></h2><div className="first-farm-copy"><p>{content.firstFarm}</p><p>{content.lessons}</p><p>{content.farming}</p></div></section>
  ...
  <footer className="contact" id="contact"><div className="contact-top"><h2>Let's grow<br/>something<br/><em>that lasts.</em></h2><div className="contact-copy"><p>{content.contact}</p><a className="pill pill-lime" href={mailto}>Start a conversation <Arrow/></a></div></div><div className="footer-wordmark" aria-hidden="true"><span>School Farm</span><span>Network<sup>●</sup></span></div><div className="footer-bottom"><p>School Farm Network · Nairobi, Kenya</p><a href={mailto}>{content.email}</a><p>© 2026</p></div></footer>
 </div>
}
