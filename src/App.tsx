...
export default function App(){
 ...
 return <div ref={scope} id="top" className="direction-photo"><a className="skip-link" href="#main">Skip to content</a>
  ...
  <footer className="contact" id="contact"><div className="contact-top"><h2>Let's grow<br/>something<br/><em>that lasts.</em></h2><div className="contact-copy"><p>{content.contact}</p><a className="pill pill-lime" href={mailto}>Start a conversation <Arrow/></a></div></div><div className="footer-wordmark" aria-hidden="true"><span>School Farm</span><span>Network<sup>●</sup></span></div><div className="footer-bottom"><p>© {new Date().getFullYear()} School Farm Network</p><a className="back-top" href="#top">Back to top <Arrow direction="up"/></a></div></footer>
 </div>
}
